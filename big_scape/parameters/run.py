...
class RunParameters(Namespace):
    ...
    Attributes:
        ...
        hmmer: parameters.HmmerParameters
        binning: parameters.BinningParameters
        comparison: parameters.ComparisonParameters
        networking: parameters.NetworkingParameters
        diagnostics: parameters.DiagnosticsParameters
