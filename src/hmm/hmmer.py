...
class HMMer:
    ...
    def hmmsearch_simple(cds_list: list[CDS]) -> Iterator[HSP]:
        ...
        HSP objects generated by iterator contain domain and score information, and a
        link to the related CDS

        Args:
            cds_list (list[CDS]): list of CDS to generate HSPs for

        Yields:
            Iterator[HSP]: an iterator generating HSPs that are included (score >
            trusted cutoff)
        """
            ...
            for connection in available_connections:
                ...
                if output_data is not None:
                    ...
                    for task_output in task_outputs:
                        yield task_output_to_hsp(task_output, cds_list)
