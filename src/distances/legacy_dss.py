...
def get_distance_from_unshared(
    ...
    a_domains_bot: dict[str, Any] = {}
    b_domains_bot: dict[str, Any] = {}
    a_domains_top: dict[str, Any] = {}
    b_domains_top: dict[str, Any] = {}
    ...
    for unshared_domain in unshared_domains:
        # maybe another bug: because of the implementation in 1.0, if there is 1 occurence of
        # a domain in B, but none in A, it will take 0 as unshared instead of 1!
        try:
            num_unshared = (
                a_domains_top[unshared_domain.domain]
                - a_domains_bot[unshared_domain.domain]
            )
        except KeyError:
            num_unshared = (
                b_domains_top[unshared_domain.domain]
                - b_domains_bot[unshared_domain.domain]
            )
