...
def cmd_parser():
    ...
    parser.add_argument(
        "--db_path", dest="db_path", help="Path to location of sqlite db output."
    )

    parser.add_argument(
        "--log_path", dest="log_path", help="Path to location of output log file."
    )
    ...
    parser.add_argument(
        "--profiling", dest="profiling", help="Run profiler and output profile report"
    )
